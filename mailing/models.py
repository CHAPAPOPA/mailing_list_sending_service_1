...
class Newsletter(models.Model):
    ...
    end_date = models.DateTimeField(
        verbose_name="дата и время окончанмя рассылки", null=True, blank=True
    )
    ...
    clients = models.ManyToManyField(
        Client, blank=True, related_name="clients", verbose_name="Клиенты"
    )
...
class Attempt(models.Model):
    ...
    newsletter = models.ForeignKey(
        Newsletter, on_delete=models.CASCADE, related_name="newsletter"
    )
